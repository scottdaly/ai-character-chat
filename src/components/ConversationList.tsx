...
export default function ConversationList() {
  ...
  const { conversations, loadConversations, deleteConversation } = useConversations(characterId!);
    ...
    <div className="p-4">
      ...
      <div className="space-y-2">
        {conversations.map(convo => {
          const isSelected = location.pathname.endsWith(`/conversations/${convo.id}`);
          return (
            <Link
              key={convo.id}
